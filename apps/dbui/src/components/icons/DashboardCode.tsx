...
<path fillRule="evenodd" clipRule="evenodd" d="M14.25 1C14.6642 1 15 1.33579 15 1.75V8.5H13.5V7H8.75V8.5H7.25V2.5H2.5V9H7L5.5 10.5H2.5V13.5H5V15H1.75C1.33579 15 1 14.6642 1 14.25V1.75C1 1.33579 1.33579 1 1.75 1H14.25ZM8.75 5.5H13.5V2.5H8.75V5.5Z" fill="currentColor"/>
</svg>
  )
)
