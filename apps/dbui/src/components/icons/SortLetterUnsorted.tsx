...
const SortLetterUnsorted = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
  ({ className, size = 16, ...props }, ref) => (
    <svg ref={ref} className={className} {...props} width={size} height={size} viewBox="0 0 16 16" fill="none">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M4 1C4.27363 1 4.52007 1.1726 4.62305 1.43652L7 7.5332H5.54883L5.18457 6.59961H2.81543L2.45117 7.5332H1L3.37695 1.43652C3.47993 1.1726 3.72637 1 4 1ZM3.36133 5.2002H4.63867L4 3.56152L3.36133 5.2002Z" fill="currentColor"/>
    </svg>
  )
)
