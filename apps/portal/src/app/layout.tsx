      ...
      <head>
        ...
        */}
        ...
        {/*
          ...
          one value this script deliberately does not write. The default mode is
          whatever the machine asks for, which is why the fallback is
          `prefers-color-scheme` rather than light.
        */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var q=new URLSearchParams(location.search);var s=q.get("scale")||localStorage.getItem("dbui-type-scale");if(s==="1"||s==="1.4")document.documentElement.dataset.typeScale=s;var t=q.get("theme")||localStorage.getItem("dbui-color-mode");if(t!=="light"&&t!=="dark")t=matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";if(t==="dark")document.documentElement.classList.add("dark")}catch(e){}})()`,
          }}
        />
      </head>
