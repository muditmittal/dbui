...
import { ShellsGallery, SHELLS_GROUP } from "./ShellsGallery"
...
const SECTIONS = [
  ...
  // Appended rather than generated. Chat and Shells come from their own packages,
  // which `component-index.md` does not cover — see the note in `ChatGallery`.
  CHAT_GROUP,
  SHELLS_GROUP,
]
