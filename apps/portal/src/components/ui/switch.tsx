...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "peer group/switch relative inline-flex shrink-0 items-center rounded-full border border-transparent transition-all outline-none after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:shadow-focus aria-invalid:border-destructive data-[size=default]:h-4 data-[size=default]:w-7 data-[size=sm]:h-3 data-[size=sm]:w-5 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 data-checked:bg-primary data-checked:hover:bg-primary-hover data-checked:active:bg-primary-press data-unchecked:bg-input data-unchecked:hover:bg-hover data-unchecked:hover:border-primary-hover data-unchecked:active:bg-press data-unchecked:active:border-primary-press dark:data-unchecked:bg-input/80 data-disabled:cursor-not-allowed data-disabled:bg-disabled data-checked:data-disabled:bg-disabled",
        className
      )}
      {...props}
    >
