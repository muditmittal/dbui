...
export const PATTERNS: Pattern[] = [
  ...
  },
  {
    ...
    donts: [
      "Label a trigger “more” or “details” instead of what it holds",
  ...
  },
  {
    ...
    donts: [
      ...
      "Use a wizard for two steps. Two steps is one dialog",
      ...
      "Ask for a value the reader already entered after a commit fails",
  ...
  },
  {
    ...
    donts: [
      ...
      "Let a dismissible banner be the only record that a result was ever incomplete",
