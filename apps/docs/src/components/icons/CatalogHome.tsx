...
<path fill-rule="evenodd" clip-rule="evenodd" d="M14 6.5V0.75C14 0.335786 13.6642 0 13.25 0H4.5C3.11929 0 2 1.11929 2 2.5V13.25C2 14.7688 3.23122 16 4.75 16H6.5V14.5H4.75C4.05964 14.5 3.5 13.9404 3.5 13.25V4.79198C3.80623 4.92578 4.14445 5 4.5 5H12.5V6.5H14ZM4.5 3.5C3.94772 3.5 3.5 3.05228 3.5 2.5C3.5 1.94772 3.94772 1.5 4.5 1.5H12.5V3.5H4.5Z" fill="currentColor"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M12.4573 7.90553C12.1877 7.69816 11.8123 7.69816 11.5427 7.90553L8.29272 10.4055C8.10815 10.5475 8 10.7671 8 11V15.25C8 15.6642 8.33579 16 8.75 16H15.25C15.6642 16 16 15.6642 16 15.25V11C16 10.7671 15.8918 10.5475 15.7073 10.4055L12.4573 7.90553ZM9.5 14.5V11.3693L12 9.44622L14.5 11.3693V14.5H12.75V12H11.25V14.5H9.5Z" fill="currentColor"/>
</svg>
  )
)
