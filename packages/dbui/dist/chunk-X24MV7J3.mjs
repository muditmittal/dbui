...
import React__default__default, { useState, useMemo, useLayoutEffect, useEffect } from 'react';
...
var useLayoutEffect2 = (globalThis == null ? void 0 : globalThis.document) ? React__default.useLayoutEffect : () => {
};
...
function createSlot(ownerName) {
  ...
  const Slot2 = React__default.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx(SlotClone, __spreadProps(__spreadValues({}, slotProps), { ref: forwardedRef, children: React__default.isValidElement(newElement) ? React__default.cloneElement(newElement, void 0, newChildren) : null }));
    }
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node2 = React__default.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(Comp, __spreadProps(__spreadValues({}, primitiveProps), { ref: forwardedRef }));
  });
...
function useCallbackRef(callback) {
  ...
  return React__default.useMemo(() => (...args) => {
    var _a;
...
var DismissableLayerBranch = React__default.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx(Primitive.div, __spreadProps(__spreadValues({}, props), { ref: composedRefs }));
});
...
var FocusScope = React__default.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx(Primitive.div, __spreadProps(__spreadValues({ tabIndex: -1 }, scopeProps), { ref: composedRefs, onKeyDown: handleKeyDown }));
});
...
var Portal = React__default.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM__default.createPortal(/* @__PURE__ */ jsx(Primitive.div, __spreadProps(__spreadValues({}, portalProps), { ref: forwardedRef })), container) : null;
});
...
var DialogOverlay = React__default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? /* @__PURE__ */ jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx(DialogOverlayImpl, __spreadProps(__spreadValues({}, overlayProps), { ref: forwardedRef })) }) : null;
  }
);
...
var DialogContent = React__default.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(Presence, { present: forceMount || context.open, children: context.modal ? /* @__PURE__ */ jsx(DialogContentModal, __spreadProps(__spreadValues({}, contentProps), { ref: forwardedRef })) : /* @__PURE__ */ jsx(DialogContentNonModal, __spreadProps(__spreadValues({}, contentProps), { ref: forwardedRef })) });
  }
);
...
var DialogTitle = React__default.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(Primitive.h2, __spreadProps(__spreadValues({ id: context.titleId }, titleProps), { ref: forwardedRef }));
  }
);
...
var DialogDescription = React__default.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(Primitive.p, __spreadProps(__spreadValues({ id: context.descriptionId }, descriptionProps), { ref: forwardedRef }));
  }
);
...
var Overlay2 = /* @__PURE__ */ React__default__default.forwardRef(function(_a, ref) {
  ...
  return /* @__PURE__ */ React__default__default.createElement(Overlay, __spreadValues({
    onMouseUp,
    ref: composedRef,
    "data-vaul-overlay": "",
...
var Content2 = /* @__PURE__ */ React__default__default.forwardRef(function(_a, ref) {
  var _b = _a, { onPointerDownOutside, style, onOpenAutoFocus } = _b, rest = __objRest(_b, ["onPointerDownOutside", "style", "onOpenAutoFocus"]);
  ...
  return /* @__PURE__ */ React__default__default.createElement(Content, __spreadProps(__spreadValues({
...
var Handle = /* @__PURE__ */ React__default__default.forwardRef(function(_a, ref) {
  ...
  return /* @__PURE__ */ React__default__default.createElement("div", __spreadValues({
    ...
    "data-vaul-handle": "",
    "aria-hidden": "true"
  }, rest), /* @__PURE__ */ React__default__default.createElement("span", {
...
function Portal3(props) {
  ...
  const _a = props, { container = context.container } = _a, portalProps = __objRest(_a, ["container"]);
  return /* @__PURE__ */ React__default__default.createElement(Portal2, __spreadValues({
    container
  }, portalProps));
}
var Drawer = {
...
function Drawer2(_a) {
  ...
  return /* @__PURE__ */ jsx(Drawer.Root, __spreadValues({ "data-slot": "drawer" }, props));
}
function DrawerTrigger(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ jsx(Drawer.Trigger, __spreadValues({ "data-slot": "drawer-trigger" }, props));
}
function DrawerPortal(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ jsx(Drawer.Portal, __spreadValues({ "data-slot": "drawer-portal" }, props));
}
function DrawerClose(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ jsx(Drawer.Close, __spreadValues({ "data-slot": "drawer-close" }, props));
}
...
export { Drawer2 as Drawer, DrawerClose, DrawerContent, DrawerDescription, DrawerFooter, DrawerHeader, DrawerOverlay, DrawerPortal, DrawerTitle, DrawerTrigger };
//# sourceMappingURL=chunk-X24MV7J3.mjs.map
//# sourceMappingURL=chunk-X24MV7J3.mjs.map