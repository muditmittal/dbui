import { isAndroid, isJSDOM, ARROW_UP, ARROW_DOWN, ARROW_LEFT, ARROW_RIGHT } from './chunk-BO7ZMLYZ.mjs';
import { getComputedStyle } from './chunk-CL6E6FD3.mjs';
...
function getGridNavigatedIndex(listRef, {
  ...
  if (verticalDirection) {
    ...
    const verticalCandidate = (_a = navigateVertically(verticalDirection)) != null ? _a : navigateVerticallyWithInferredRows(verticalDirection);
...
function isListIndexDisabled(listRef, index, disabledIndices) {
  var _a;
  const isExplicitlyDisabled = typeof disabledIndices === "function" ? disabledIndices(index) : (_a = disabledIndices == null ? void 0 : disabledIndices.includes(index)) != null ? _a : false;
...
export { clamp, createCoords, createGridCellMap, evaluate, findNonDisabledListIndex, floor, getAlignment, getAlignmentAxis, getAlignmentSides, getAxisLength, getExpandedPlacements, getGridCellIndexOfCorner, getGridCellIndices, getGridNavigatedIndex, getMaxListIndex, getMinListIndex, getOppositeAxis, getOppositeAxisPlacements, getOppositePlacement, getPaddingObject, getSide, getSideAxis, isClickLikeEvent, isElementVisible, isIndexOutOfListBounds, isListIndexDisabled, isMouseLikePointerType, isReactEvent, isVirtualClick, isVirtualPointerEvent, max, min, rectToClientRect, round, sides, stopEvent };
//# sourceMappingURL=chunk-XK53VWW6.mjs.map
//# sourceMappingURL=chunk-XK53VWW6.mjs.map