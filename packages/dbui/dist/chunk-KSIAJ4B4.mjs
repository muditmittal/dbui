    ...
    return ToastState.subscribe((toast2) => {
      if (toast2.dismiss) {
        requestAnimationFrame(() => {
          setToasts((toasts2) => toasts2.map((t) => t.id === toast2.id ? __spreadProps(__spreadValues({}, t), {
            delete: true
          }) : t));
        });
        return;
...
var CheckCircleFill = forwardRef(
  (_a, ref) => {
...
var Toaster3 = (_a) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    __spreadValues({
      ...
      icons: {
        success: /* @__PURE__ */ jsx(CheckCircleFill, { className: "size-4 text-success" }),
        info: /* @__PURE__ */ jsx(InfoFill, { className: "size-4 text-foreground" }),
        warning: /* @__PURE__ */ jsx(WarningFill, { className: "size-4 text-warning" }),
        error: /* @__PURE__ */ jsx(DangerFill, { className: "size-4 text-destructive" }),
        loading: /* @__PURE__ */ jsx(Loading, { className: "size-4 animate-spin text-foreground" })
      },
      style: {
...
export { Toaster3 as Toaster };
//# sourceMappingURL=chunk-KSIAJ4B4.mjs.map
//# sourceMappingURL=chunk-KSIAJ4B4.mjs.map