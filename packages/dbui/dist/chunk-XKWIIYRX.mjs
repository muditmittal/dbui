...
import { ARROW_LEFT, ARROW_RIGHT, ARROW_UP, ARROW_DOWN, HOME, END } from './chunk-QGKCYW24.mjs';
...
import { TransitionStatusDataAttributes, transitionStatusMapping, useOpenChangeComplete, useTransitionStatus, useAnimationsFinished } from './chunk-INMEVUNJ.mjs';
import { useAnimationFrame, AnimationFrame, useOnMount } from './chunk-KJU32T43.mjs';
...
import { warn, useRenderElement, useMergedRefs, formatErrorMessage_default } from './chunk-I44XWQG6.mjs';
...
var AccordionRootContext = /* @__PURE__ */ React3.createContext(void 0);
if (process.env.NODE_ENV !== "production") AccordionRootContext.displayName = "AccordionRootContext";
function useAccordionRootContext() {
  const context = React3.useContext(AccordionRootContext);
  if (context === void 0) {
    throw new Error(process.env.NODE_ENV !== "production" ? "Base UI: AccordionRootContext is missing. Accordion parts must be placed within <Accordion.Root>." : formatErrorMessage_default(10));
  }
  return context;
}
...
var AccordionRoot = /* @__PURE__ */ React3.forwardRef(function AccordionRoot2(componentProps, forwardedRef) {
  ...
  const defaultValue = React3.useMemo(() => {
    if (valueProp === void 0) {
  ...
  const accordionItemRefs = React3.useRef([]);
  ...
  const contextValue = React3.useMemo(() => ({
    ...
    disabled,
    handleValueChange,
    hiddenUntilFound: hiddenUntilFoundProp != null ? hiddenUntilFoundProp : false,
    keepMounted: keepMountedProp != null ? keepMountedProp : false,
    loopFocus,
    orientation,
    state,
    value
...
function useCollapsibleRoot(parameters) {
  ...
  const panelId = panelIdState != null ? panelIdState : defaultPanelId;
...
var CollapsibleRootContext = /* @__PURE__ */ React3.createContext(void 0);
...
function useCollapsibleRootContext() {
  const context = React3.useContext(CollapsibleRootContext);
  if (context === void 0) {
    throw new Error(process.env.NODE_ENV !== "production" ? "Base UI: CollapsibleRootContext is missing. Collapsible parts must be placed within <Collapsible.Root>." : formatErrorMessage_default(15));
  }
  return context;
}
var AccordionItemContext = /* @__PURE__ */ React3.createContext(void 0);
...
function useAccordionItemContext() {
  ...
  if (context === void 0) {
    throw new Error(process.env.NODE_ENV !== "production" ? "Base UI: AccordionItemContext is missing. Accordion parts must be placed within <Accordion.Item>." : formatErrorMessage_default(9));
  }
  return context;
}
...
var accordionStateAttributesMapping = __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, collapsibleOpenStateMapping), {
  index: (value) => {
...
var AccordionItem = /* @__PURE__ */ React3.forwardRef(function AccordionItem2(componentProps, forwardedRef) {
  const _a = componentProps, {
    className,
  ...
  const value = valueProp != null ? valueProp : fallbackValue;
  const disabled = disabledProp || contextDisabled;
  const isOpen = React3.useMemo(() => {
    if (!openValues) {
      return false;
    }
  ...
  const collapsibleState = React3.useMemo(() => ({
  ...
  const collapsibleContext = React3.useMemo(() => __spreadProps(__spreadValues({}, collapsible), {
    onOpenChange,
    state: collapsibleState
  }), [collapsible, collapsibleState, onOpenChange]);
  const state = React3.useMemo(() => __spreadProps(__spreadValues({}, rootState), {
    index,
    disabled,
    open: isOpen
  }), [disabled, index, isOpen, rootState]);
  const [triggerId, setTriggerId] = React3.useState(useBaseUiId());
  const accordionItemContext = React3.useMemo(() => ({
    open: isOpen,
    state,
    setTriggerId,
    triggerId
...
var AccordionHeader = /* @__PURE__ */ React3.forwardRef(function AccordionHeader2(componentProps, forwardedRef) {
  const _a = componentProps, {
    render,
    className
  } = _a, elementProps = __objRest(_a, [
...
function getActiveTriggers(accordionItemRefs) {
  ...
  for (let i = 0; i < accordionItemElements.length; i += 1) {
    ...
    if (!isElementDisabled(section)) {
      const trigger = section == null ? void 0 : section.querySelector('[type="button"], [role="button"]');
...
var AccordionTrigger = /* @__PURE__ */ React3.forwardRef(function AccordionTrigger2(componentProps, forwardedRef) {
  const _a = componentProps, {
  ...
  const disabled = disabledProp != null ? disabledProp : contextDisabled;
  const {
    getButtonProps,
    buttonRef
  } = useButton({
  ...
  useIsoLayoutEffect(() => {
    ...
    if (open) {
      ...
      attributeObserver = new MutationObserver((mutationList) => {
        ...
        if (hasEndingStyle) {
          attributeObserver == null ? void 0 : attributeObserver.disconnect();
...
var AccordionPanel = /* @__PURE__ */ React3.forwardRef(function AccordionPanel2(componentProps, forwardedRef) {
  const _a = componentProps, {
    className,
    hiddenUntilFound: hiddenUntilFoundProp,
    keepMounted: keepMountedProp,
  ...
  const hiddenUntilFound = hiddenUntilFoundProp != null ? hiddenUntilFoundProp : contextHiddenUntilFound;
  const keepMounted = keepMountedProp != null ? keepMountedProp : contextKeepMounted;
  if (process.env.NODE_ENV !== "production") {
    useIsoLayoutEffect(() => {
  ...
  const panelState = React3.useMemo(() => __spreadProps(__spreadValues({}, state), {
    transitionStatus
...
function AccordionTrigger3(_a) {
  ...
  return /* @__PURE__ */ jsx(index_parts_exports.Header, { className: "flex", children: /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        children,
        /* @__PURE__ */ jsx(ChevronDown, { "data-slot": "accordion-trigger-icon", className: "pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden" }),
        /* @__PURE__ */ jsx(ChevronUp, { "data-slot": "accordion-trigger-icon", className: "pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline" })
      ]
    })
  ) });
}
...
export { Accordion, AccordionContent, AccordionItem3 as AccordionItem, AccordionTrigger3 as AccordionTrigger, CollapsibleRootContext, collapsibleOpenStateMapping, triggerOpenStateMapping, useCollapsiblePanel, useCollapsibleRoot, useCollapsibleRootContext };
//# sourceMappingURL=chunk-XKWIIYRX.mjs.map
//# sourceMappingURL=chunk-XKWIIYRX.mjs.map