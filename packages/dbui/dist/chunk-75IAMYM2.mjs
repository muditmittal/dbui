import { offset, flip, shift, limitShift, size, useFloating, autoUpdate, hide } from './chunk-PSMHWWS3.mjs';
...
import { getSide, getSideAxis, getAlignment, evaluate, getPaddingObject, getAlignmentAxis, getAxisLength, clamp } from './chunk-XK53VWW6.mjs';
...
import { DISABLED_TRANSITIONS_STYLE, EMPTY_OBJECT } from './chunk-I44XWQG6.mjs';
...
var arrow = (options, deps) => __spreadProps(__spreadValues({}, baseArrow(options)), {
...
function useAnchorPositioning(params) {
  ...
  const flipMiddleware = collisionAvoidanceSide === "none" ? null : flip(__spreadProps(__spreadValues({}, commonCollisionProps), {
  ...
  const shiftMiddleware = shiftDisabled ? null : shift((data) => {
    ...
    return __spreadProps(__spreadValues({}, commonCollisionProps), {
  ...
  middleware.push(size(__spreadProps(__spreadValues({}, commonCollisionProps), {
    apply({
      elements: {
        floating
      },
...
export { adaptiveOrigin, getDisabledMountTransitionStyles, useAnchorPositioning };
//# sourceMappingURL=chunk-75IAMYM2.mjs.map
//# sourceMappingURL=chunk-75IAMYM2.mjs.map