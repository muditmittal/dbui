...
import { formatErrorMessage_default, mergeProps, makeEventPreventable } from './chunk-I44XWQG6.mjs';
import { __objRest } from './chunk-LQPATFHW.mjs';
import * as React3 from 'react';

var CompositeRootContext = /* @__PURE__ */ React3.createContext(void 0);
if (process.env.NODE_ENV !== "production") CompositeRootContext.displayName = "CompositeRootContext";
function useCompositeRootContext(optional = false) {
  const context = React3.useContext(CompositeRootContext);
...
function useButton(parameters = {}) {
  ...
  const isCompositeItem = compositeProp != null ? compositeProp : compositeRootContext !== void 0;
  const {
  ...
  const getButtonProps = React3.useCallback((externalProps = {}) => {
    const _a = externalProps, {
      onClick: externalOnClick,
      onMouseDown: externalOnMouseDown,
      onKeyUp: externalOnKeyUp,
      onKeyDown: externalOnKeyDown,
      onPointerDown: externalOnPointerDown
    } = _a, otherExternalProps = __objRest(_a, [
      "onClick",
      "onMouseDown",
      "onKeyUp",
      "onKeyDown",
...
export { CompositeRootContext, useButton, useCompositeRootContext };
//# sourceMappingURL=chunk-ETMT7VCK.mjs.map
//# sourceMappingURL=chunk-ETMT7VCK.mjs.map