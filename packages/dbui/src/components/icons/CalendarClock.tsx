...
<path fill-rule="evenodd" clip-rule="evenodd" d="M4.5 0V2H1.75C1.33579 2 1 2.33579 1 2.75V14.25C1 14.6642 1.33579 15 1.75 15H6V13.5H2.5V7H15V2.75C15 2.33579 14.6642 2 14.25 2H11.5V0H10V2H6V0H4.5ZM13.5 5.5V3.5H2.5V5.5H13.5Z" fill="currentColor"/>
