...
const SortLetterHorizontalDescending = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
  ({ className, size = 16, ...props }, ref) => (
    <svg ref={ref} className={className} {...props} width={size} height={size} viewBox="0 0 16 16" fill="none">
      <g clip-path="url(#clip0_35_4794)">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M4.30762 9C4.61448 9.00041 4.8905 9.18754 5.00391 9.47266L7.59668 16H5.98242L5.74414 15.4004H2.85547L2.61523 16H1L3.61035 9.47168C3.72433 9.1866 4.0006 8.99966 4.30762 9ZM3.45508 13.9004H5.14844L4.30469 11.7754L3.45508 13.9004Z" fill="currentColor"/>
