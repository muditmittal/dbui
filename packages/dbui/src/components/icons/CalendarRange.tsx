...
<g clipPath="url(#clip0_35_4740)">
<path fillRule="evenodd" clipRule="evenodd" d="M6 2H10V0H11.5V2H14.25C14.6642 2 15 2.33579 15 2.75V8.5H13.5V7H2.5V13.5H8V15H1.75C1.33579 15 1 14.6642 1 14.25V2.75C1 2.33579 1.33579 2 1.75 2H4.5V0H6V2ZM2.5 5.5H13.5V3.5H2.5V5.5Z" fill="currentColor"/>
