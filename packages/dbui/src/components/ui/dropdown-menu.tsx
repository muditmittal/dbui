...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "px-1.5 py-1 text-[11px] font-semibold text-muted-foreground data-inset:pl-7",
        className
      )}
      {...props}
    />
