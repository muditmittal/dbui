...
function RadioGroupItem({ className, ...props }: RadioPrimitive.Root.Props) {
  return (
    ...
    >
      ...
      >
        <span className="absolute top-1/2 left-1/2 size-1.5 -translate-x-1/2 -translate-y-1/2 shape-pill bg-action-label-inverse-base" />
      </RadioPrimitive.Indicator>
    </RadioPrimitive.Root>
  )
}
