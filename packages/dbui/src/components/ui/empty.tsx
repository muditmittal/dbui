...
function Empty({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="empty"
      className={cn(
        "flex w-full min-w-0 flex-1 flex-col items-center justify-center gap-4 shape-container-lg border-dashed p-6 text-center text-balance",
        className
      )}
      {...props}
    />
  ...
  "mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        icon: "flex size-8 shrink-0 items-center justify-center shape-container-md bg-surface-subtle text-text-base [&_svg:not([class*='size-'])]:size-4",
      },
    },
    defaultVariants: {
      variant: "default",
...
function EmptyTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("type-body-bold", className)}
      {...props}
    />
  )
}
...
function EmptyDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <div
      ...
      className={cn(
        "type-body text-text-subtle [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-link-base",
        className
      )}
      {...props}
    />
