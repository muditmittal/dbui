...
function DateRangeField({
 ...
 disabled={disabled}
 className={cn(
        "group/date-range-field inline-flex shrink-0 items-center rounded-1 border border-input-border-base bg-surface-base type-label shadow-control transition-colors outline-none",
