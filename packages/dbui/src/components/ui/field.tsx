...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:border-action-primary-base/30 has-data-checked:bg-action-primary-base/5 has-[>[data-slot=field]]:shape-container-md has-[>[data-slot=field]]:border *:data-[slot=field]:p-3 dark:has-data-checked:border-action-primary-base/20 dark:has-data-checked:bg-action-primary-base/10",
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left type-body text-text-subtle group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-2",
