 ...
 * Selected item: bg-white, border-primary, shadow-xs, text-text-accent
  ...
  return (
    <TogglePrimitive
      ...
      className={cn(
        ...
        "aria-pressed:bg-surface-base aria-pressed:border-primary aria-pressed:text-text-accent aria-pressed:shadow-xs",
        "data-[state=on]:bg-surface-base data-[state=on]:border-primary data-[state=on]:text-text-accent data-[state=on]:shadow-xs",
