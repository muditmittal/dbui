      ...
      <SliderPrimitive.Control className="relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
        ...
        {Array.from({ length: _values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            ...
            key={index}
            className="relative block size-3.5 shrink-0 shape-pill bg-action-primary-base shadow-control transition-[color,box-shadow] select-none after:absolute after:-inset-2 hover:bg-action-primary-hover focus-visible:shadow-focus focus-visible:outline-hidden active:bg-action-primary-press disabled:bg-surface-disabled disabled:pointer-events-none"
          />
        ))}
