...
function SelectScrollUpButton({
 ...
 className={cn(
        "top-0 z-raised flex w-full cursor-default items-center justify-center bg-surface-base py-1 [&_svg:not([class*='size-'])]:size-4",
 className
      )}
      {...props}
    >
...
function SelectScrollDownButton({
 ...
 className={cn(
        "bottom-0 z-raised flex w-full cursor-default items-center justify-center bg-surface-base py-1 [&_svg:not([class*='size-'])]:size-4",
 className
      )}
      {...props}
    >
