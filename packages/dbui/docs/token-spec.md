Token	Category	Value	At16pxRoot	Dark
...
--db-viz-level-high-base	Color	#E65B77		#F792A6
--db-viz-level-high-strong	Color	#9E102C		#FBD0D8
--db-viz-level-high-subtle	Color	#FFF5F7		#630316
--db-viz-level-info-base	Color	#A3E3F7		#65D3F4
--db-viz-level-info-strong	Color	#1D819B		#21A1C2
--db-viz-level-info-subtle	Color	#CEEDF8		#164A5A
--db-viz-level-low-base	Color	#F9E9BA		#9D662C
--db-viz-level-low-strong	Color	#9D662C		#BD7C30
--db-viz-level-low-subtle	Color	#F9F7EF		#5E3C1C
--db-viz-level-medium-base	Color	#DE7921		
--db-viz-level-medium-strong	Color	#BE501E		#DE7921
--db-viz-level-medium-subtle	Color	#FFF9EB		#5F1B02
--db-viz-level-pass-base	Color	#8DDDA8		#D4F7DF
--db-viz-level-pass-strong	Color	#277C43		#8DDDA8
--db-viz-level-pass-subtle	Color	#D4F7DF		#093919
--db-viz-neutral-base	Color	rgba(21, 53, 63, 0.08)		rgba(206, 237, 248, 0.08)
--db-viz-neutral-strong	Color	rgba(21, 53, 63, 0.48)		rgba(206, 237, 248, 0.48)
--db-viz-neutral-subtle	Color	rgba(21, 53, 63, 0.04)		rgba(206, 237, 248, 0.04)
--db-viz-sequential-1	Color	#E5F4F9		#15353F
--db-viz-sequential-10	Color	#15353F		#E5F4F9
--db-viz-sequential-2	Color	#CEEDF8		#164A5A
--db-viz-sequential-3	Color	#A3E3F7		#186376
--db-viz-sequential-4	Color	#65D3F4		#1D819B
--db-viz-sequential-5	Color	#28C1E7		#21A1C2
--db-viz-sequential-6	Color	#21A1C2		#28C1E7
--db-viz-sequential-7	Color	#1D819B		#65D3F4
--db-viz-sequential-8	Color	#186376		#A3E3F7
--db-viz-sequential-9	Color	#164A5A		#CEEDF8
