...
/**
 * Shell — the Databricks Base shell. EVERY product page starts here.
 *
 * Provides:
 ...
 *   </Shell>
 *
 *   <Shell defaultActive="editor" sidebarCollapsed>
 *     <NotebookEditor ... />
 *   </Shell>
 */
export function Shell({
  ...
  /** Called when sidebar toggle is clicked — if not provided, Shell manages its own state */
