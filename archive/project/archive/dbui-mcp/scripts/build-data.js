...
// ── Icons ──
// Source moved to project/ pending L2 auto-generation (see project/ARCHITECTURE.md).
const iconMd = fs.readFileSync(path.join(REPO, "project/icon-index.md"), "utf-8")
...
// ── Components ──
// Source moved to project/ pending L2 auto-generation (see project/ARCHITECTURE.md).
const compMd = fs.readFileSync(path.join(REPO, "project/component-index.md"), "utf-8")
