...
const redRes = lookupToken.run({ value: "#FF0000", type: "color", mode: "light" })
...
const sp7 = lookupToken.run({ value: "7px", type: "spacing" })
const sp5 = lookupToken.run({ value: "5px", type: "spacing" })
