...
url: https://carbondesignsystem.com/elements/typography/
license: Apache-2.0
bucket: A
...
Using productive type styles on tabs provides a distinction in scale. It creates a hierarchy that keeps focus on the results.
