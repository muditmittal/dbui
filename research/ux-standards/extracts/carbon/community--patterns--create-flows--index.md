...
Upcoming 80px fluid button height in the wide tearsheet
...
Toggle view - show all available options
...
Animated illustration of the "Show all available options" toggle behavior
...
Toggle view - hide all available options warning modal (when needed)
...
Upcoming 80px fluid button height in the Full page flow
...
With Full page flows, show a confirmation modal when the user navigates away.
