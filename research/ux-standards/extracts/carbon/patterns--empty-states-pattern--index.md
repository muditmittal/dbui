...
| User action empty states      | Provides feedback based on some user action. For example: <br /><br /> No results when searchingConfirmation of completion of a process | User understands how to adjust search terms or filters to continue their search. <br /><br />User understands that they’ve successfully completed a process. | User understands that they’ve successfully completed a process. When you need to provide feedback to the user based on an interaction.                       |
