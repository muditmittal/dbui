...
| -------- | ----------------------- | ------------- | --------- | -----------------------------------------: |
| White    | Global Background Light | `$background` | `#ffffff` | #ffffff |
| Gray 10  | Global Background Light | `$background` | `#f4f4f4` | #f4f4f4 |
| Gray 90  | Global Background Dark  | `$background` | `#262626` | #282828 |
| Gray 100 | Global Background Dark  | `$background` | `#161616` | #171717 |
