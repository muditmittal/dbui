...
url: https://www.patternfly.org/components/accessibility/clipboard-copy
license: MIT
bucket: A
...
At a minimum, a clipboard copy should meet the following criteria:
    ...
    Both <kbd>Space</kbd> and <kbd>Enter</kbd> should activate any toggles or buttons within the clipboard copy.</span>}/>
