...
url: https://www.patternfly.org/components/accessibility/avatar
license: MIT
bucket: A
...
At a minimum, an avatar should meet the following criteria:
    ...
    How to create accessible SVGs</span>}/>


    Keyboard users should not be able to interact with the avatar on its own (via <kbd>Tab</kbd> and <kbd>Tab + Shift</kbd>).</span>} />
