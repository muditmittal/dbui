...
url: https://www.patternfly.org/components/charts/donut-utilization-chart
license: MIT
bucket: A
...
2. **Used segment fill:** We recommend using #0066cc for the used area of the donut chart. See [chart colors](/components/charts/colors-for-charts) for other recommended color options.
