...
url: https://www.patternfly.org/components/charts/pie-chart
license: MIT
bucket: A
...
1. **Pie chart fill:** We recommend fill colors based on the [chart colors](/components/charts/colors-for-charts).
