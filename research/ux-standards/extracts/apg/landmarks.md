...
[Landmarks](#landmark) are a set of eight roles that identify the major sections of a page.
...
For example, the [main](#main) landmark designates the section that contains the main content of the page.
...
The [Landmark Regions Practice](../../practices//landmark-regions//landmark-regions-practice.html) describes ways of using HTML sectioning elements and ARIA landmark roles that will most benefit users.
